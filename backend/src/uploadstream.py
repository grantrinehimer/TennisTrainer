#!/usr/bin/env python3
"""
Convert a .mp4 file into HlS, upload to AWS, and remove local .mp4 and HLS files
...
def upload_to_aws(s3, bucket_name: str, bucket_region: str, path_to_fmp4: str) -> str:
    ...
    object_url = f"https://{bucket_name}.s3.{bucket_region}.amazonaws.com/hls/{fmp4_filename}/index.m3u8"
    return object_url
...
def main() -> None:
    ...
    if len(sys.argv) < 2:
        print(f"Usage: uploadstream.py path/to/file.mp4")
        return
    # The workflow
